...
[This project](https://github.com/quixio/quix-samples/tree/main/python/sources/TFL-Bikepoint) will allow you to connect to the Transport For London (TfL) BikePoint API.
